...
OMEGA_STAGES: Dict[str, Dict[str, Any]] = {
    ...
    "stage3b_height_focused_control": {
        "mode": "train",
        "description": "Return to plain shuffled batches and simplify the objective around height.",
        "variant": "height_focused_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage3b_height_focused_no_physics",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            "model.v2.toggles.use_physics_branch": False,
            "model.v2.toggles.use_cross_attention": False,
            ...
            "training.loss.task_weights.weight": 0.25,
            "training.loss.task_weights.age": 0.25,
            "training.loss.task_weights.gender": 0.20,
    ...
    "stage3c_height_only_regularized": {
        "mode": "train",
        "description": "Height-only no-physics control with stronger regularization and a lower learning rate.",
        "variant": "height_only_regularized_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage3c_height_only_regularized",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            "model.v2.ecapa_channels": 128,
            ...
            "training.optimizer.weight_decay": 0.02,
            "training.loss.task_weights.height": 4.0,
    ...
    "stage3d_height_only_slice_aligned": {
        "mode": "train",
        "description": "Stage 3c plus slice-aware speaker sampling, pooled speaker losses, and gentle stability smoothing.",
        "variant": "height_only_slice_aligned_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage3d_height_only_slice_aligned",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            "model.v2.ecapa_channels": 128,
            "model.v2.conformer_d_model": 64,
            ...
            "training.speaker_batching.gender_balance_strength": 0.20,
            "training.speaker_batching.height_bin_weights.short": 1.8,
            "training.speaker_batching.height_bin_weights.medium": 1.0,
            "training.speaker_batching.height_bin_weights.tall": 1.15,
            "training.speaker_alignment.enable_pooled_height": True,
            "training.speaker_alignment.enable_consistency": True,
            "training.speaker_alignment.enable_ranking": True,
            "training.speaker_alignment.pooling_method": "mean",
            "training.speaker_alignment.consistency_mode": "variance",
            "training.speaker_alignment.warmup_start_epoch": 2,
            "training.speaker_alignment.warmup_end_epoch": 2,
            "training.speaker_alignment.pooled_height_weight_max": 0.20,
            "training.speaker_alignment.consistency_weight_max": 0.08,
            "training.speaker_alignment.ranking_weight_max": 0.06,
            "training.speaker_alignment.ranking_min_height_delta_cm": 4.0,
            "training.speaker_alignment.ranking_margin_cm": 1.0,
            "training.speaker_alignment.height_bin_loss_start_epoch": 1,
            "training.speaker_alignment.height_bin_loss_weight_short": 1.35,
            "training.speaker_alignment.height_bin_loss_weight_medium": 1.0,
            "training.speaker_alignment.height_bin_loss_weight_tall": 1.10,
            "training.feature_smoothing_std": 0.012,
    ...
    "stage3e_height_only_stable_bin_weighted": {
        "mode": "train",
        "description": "Stage 3c backbone with gentle hard-slice weighting, feature smoothing, and monotonic cosine decay.",
        "variant": "height_only_stable_bin_weighted_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage3e_height_only_stable_bin_weighted",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            "model.v2.ecapa_channels": 128,
            "model.v2.conformer_d_model": 64,
            ...
            "training.scheduler.eta_min": 1.0e-05,
            "training.loss.task_weights.height": 4.0,
            "training.loss.task_weights.weight": 0.0,
            "training.loss.task_weights.age": 0.0,
            "training.loss.task_weights.gender": 0.0,
            ...
            "training.speaker_alignment.enable_ranking": False,
            "training.speaker_alignment.height_bin_loss_start_epoch": 1,
            "training.speaker_alignment.height_bin_loss_weight_short": 1.25,
            "training.speaker_alignment.height_bin_loss_weight_medium": 1.0,
            "training.speaker_alignment.height_bin_loss_weight_tall": 1.05,
            "training.feature_smoothing_std": 0.010,
            "training.lr_warmup_epochs": 1,
            "training.lr_warmup_start_factor": 0.25,
        },
    },
    "stage3f_height_only_long_stable": {
        "mode": "train",
        "description": "Stage 3c objective and plain shuffled batches, extended to 50 epochs with monotonic cosine decay.",
        "variant": "height_only_long_stable_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage3f_height_only_long_stable",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            "model.v2.ecapa_channels": 128,
            "model.v2.conformer_d_model": 64,
    ...
    "stage3g_height_only_strong_reg": {
        "mode": "train",
        "description": "Stage 3f height-only line with stronger dropout, earlier focal weighting, stronger short-bin emphasis, and slower EMA.",
        "variant": "height_only_strong_reg_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage3g_height_only_strong_reg",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            "model.v2.ecapa_channels": 128,
            "model.v2.conformer_d_model": 64,
            "model.v2.conformer_blocks": 1,
            "model.v2.dropout": 0.35,
            "model.v2.branch_dropout": 0.20,
            "model.v2.drop_path_rate": 0.10,
            "model.v2.toggles.use_physics_branch": False,
            "model.v2.toggles.use_cross_attention": False,
            "model.v2.toggles.use_reliability_gate": False,
            "model.v2.toggles.use_height_prior": False,
            ...
            "training.scheduler.type": "cosine_annealing",
            "training.scheduler.T_max": 50,
            "training.scheduler.eta_min": 5.0e-06,
            "training.loss.task_weights.height": 4.0,
            "training.loss.task_weights.weight": 0.0,
            "training.loss.task_weights.age": 0.0,
            "training.loss.task_weights.gender": 0.0,
            ...
            "training.loss.task_weights.physics_penalty": 0.0,
            "training.loss.physics_penalty_weight": 0.0,
            "training.loss.focal_after_epoch": 3,
            "training.loss.focal_ema_decay": 0.90,
            "training.ema.decay": 0.999,
            "training.speaker_batching.enabled": False,
            "training.speaker_batching.height_bin_weights.short": 3.5,
            "training.speaker_batching.height_bin_weights.medium": 1.0,
            "training.speaker_batching.height_bin_weights.tall": 1.3,
            "training.speaker_alignment.enable_pooled_height": False,
            "training.speaker_alignment.enable_consistency": False,
            "training.speaker_alignment.enable_ranking": False,
            "training.speaker_alignment.height_bin_loss_start_epoch": 1,
            "training.speaker_alignment.height_bin_loss_weight_short": 3.5,
            "training.speaker_alignment.height_bin_loss_weight_medium": 1.0,
            "training.speaker_alignment.height_bin_loss_weight_tall": 1.3,
            "training.early_stopping.patience": 15,
        },
    },
    "stage4_proper_v2_height_first": {
        "mode": "train",
        "description": "Proper VocalMorph V2 rebuild: height-first representation, dedicated context refiner, and slice-aware height-bin auxiliary loss.",
        "variant": "proper_v2_height_first_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage4_proper_v2_height_first",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            ...
            "training.lr_warmup_epochs": 1,
            "training.lr_warmup_start_factor": 0.25,
            "training.early_stopping.patience": 12,
        },
    },
