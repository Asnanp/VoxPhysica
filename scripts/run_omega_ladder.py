...
OMEGA_STAGES: Dict[str, Dict[str, Any]] = {
    ...
    "stage3d_height_only_slice_aligned_stable": {
        "mode": "train",
        "description": (
            "Stage 3d with the restart-heavy schedule replaced by monotonic "
            "cosine decay; every other Stage 3d component is preserved "
            "(slice-aware sampling, pooled speaker losses, smoothing)."
        ),
        "variant": "height_only_slice_aligned_stable_no_physics",
        "monitor": "height_mae_speaker",
        "overrides": {
            "model.type": "omega_stage3d_height_only_slice_aligned_stable",
            "model.v2.aggregation.method": "legacy_inverse_variance",
            "model.v2.reliability.mode": "handcrafted",
            "model.v2.ecapa_channels": 128,
            "model.v2.conformer_d_model": 64,
