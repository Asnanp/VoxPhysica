...
## stage3d_height_only_slice_aligned_stable / seed 11
...
- Config diff: `C:\Users\USER\Downloads\VoxPhysica-main\VoxPhysica-main\outputs/omega\stage3d_height_only_slice_aligned_stable\height_only_slice_aligned_stable_no_physics\seed_11\config_diff.json`

- Legacy val/test speaker MAE: `4.211` / `5.938`
- Omega val/test speaker MAE: `4.499` / `5.919`
- Train->val gaps: legacy `1.581`, omega `1.887`
- Critical slices: legacy[src=0.829,gender=0.779,height=0.782,quality=3.464]; omega[src=1.145,gender=0.903,height=0.777,quality=3.468]; max_deg=0.552
- Calibration: cal=5.283, corr=0.085, p68=0.227, p95=0.403
