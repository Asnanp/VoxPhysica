...
class LossWeights:
    ...
    gender: float = 0.5
    vtsl: float = 0.2
    formant_height_consistency: float = 0.02
    physics_penalty: float = 0.1
    domain_adv: float = 0.05
    ranking: float = 0.075
    height_bin: float = 0.0
    diversity: float = 1.0
...
class SpeakerAlignmentConfig:
    ...
    height_bin_loss_weight_male_tall: float = 1.0
    height_bin_loss_weight_female_tall: float = 1.0
    ...
    height_bin_prior_blend: float = 0.0
    height_bin_prior_short_cm: float = 154.0
    height_bin_prior_medium_cm: float = 167.5
    height_bin_prior_tall_cm: float = 184.0
    height_distribution_weight_max: float = 0.0
    height_distribution_start_epoch: int = 1
    height_distribution_min_items: int = 8
    height_distribution_std_weight: float = 1.0
    height_distribution_range_weight: float = 0.50
    height_distribution_tail_weight: float = 0.50
